...
### 🎨 権利方針: キャラ画像は「削除対応前提」で掲載 (2026-07-31 改定)

経緯: 公式サポート (help@nikke-jp.com) に画像使用可否を照会 (2026-07-31 送信) →
一次返信「ガイドラインについて調査中・案内可能になり次第連絡」(2026-07-31 受信) →
**返信を待たず、指摘があれば即時削除する前提 (takedown 方式) でキャラ画像を使用する運営判断**
(削除対応する旨は返信済み)。
